...
- (NSString *)dateStringFromSecond:(NSInteger)second separator:(NSString *)separator{
    NSDate * date = [NSDate dateWithTimeIntervalSince1970:second];
    NSDateComponents *dateComponent = [self dateCompoentFromDate:date];
    return [NSString stringWithFormat:@"%04ld%@%02ld%@%02ld %02ld:%02ld", dateComponent.year, separator, dateComponent.month, separator, dateComponent.day, dateComponent.hour, dateComponent.minute];
    
}

- (NSString *)dateStringFromSecondFull:(NSInteger)second separator:(NSString *)separator{
    NSDate * date = [NSDate dateWithTimeIntervalSince1970:second];
    NSDateComponents *dateComponent = [self dateCompoentFromDate:date];
    return [NSString stringWithFormat:@"%04ld%@%02ld%@%02ld %02ld:%02ld:%02ld", dateComponent.year, separator, dateComponent.month, separator, dateComponent.day, dateComponent.hour, dateComponent.minute,dateComponent.second];
}

- (NSString *)dateStringFromSecondYMR:(NSInteger)second separator:(NSString *)separator {
    NSDate * date = [NSDate dateWithTimeIntervalSince1970:second];
    NSDateComponents *dateComponent = [self dateCompoentFromDate:date];
    return [NSString stringWithFormat:@"%04ld%@%02ld%@%02ld", dateComponent.year, separator, dateComponent.month, separator, dateComponent.day];
}
